    ...
    return (
        <React.Fragment>
            <div className="container">
                ...
                <p>Becoming a Cicerone is more then just tasting beer and knowing what hop or malt that were used. It is the ability to give the best quality beer and experince at every service occasion.</p>
            </div>
            <div className='container'>
