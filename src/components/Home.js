                ...
                <CardGroup className='container mt-3'>
                    <Card>
                        ...
                        <CardBody className='d-flex flex-column'>
                            ...
                            <Button className='mt-auto' outline color='warning'><Link to='beer-server'>Learn More</Link></Button>
                        </CardBody>
                    </Card>
                    <Card>
                        ...
                        <CardBody className='d-flex flex-column'>
                            ...
                            <Button className='mt-auto' outline color='warning'><Link to='cicerone'>Learn More</Link></Button>
                        </CardBody>
                    </Card>
                    <Card>
                        ...
                        <CardBody className='d-flex flex-column'>
                            ...
                            <Button className='mt-auto' outline color='warning'><Link to='advanced-cicerone'>Learn More</Link></Button>
                        </CardBody>
                    </Card>
                    <Card>
                        ...
                        <CardBody className='d-flex flex-column'>
                            ...
                            <Button className='mt-auto' outline color='warning'><Link to='master-cicerone'>Learn More</Link></Button>
                        </CardBody>
                    </Card>
                </CardGroup>
            </div>
